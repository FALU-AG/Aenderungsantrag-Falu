...
const rolePermissions: Record<RoleKey, readonly Permission[]> = {
  EMPLOYEE: ["CHANGE_REQUEST_CREATE", "CHANGE_REQUEST_VIEW", "TASK_UPDATE"],
  AVOR: ["CHANGE_REQUEST_APPROVE_AVOR", "AVOR_REVIEW_EDIT", "PURCHASING_EDIT", "TASK_CREATE", "CHANGE_REQUEST_CLOSE"],
  TECHNICAL: ["CHANGE_REQUEST_APPROVE_TECHNICAL", "TECHNICAL_REVIEW_EDIT", "TASK_CREATE", "CHANGE_REQUEST_CLOSE"],
