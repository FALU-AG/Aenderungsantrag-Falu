...
import { hasUserBusinessHistory, normalizeRoles, ROLE_LABELS, USER_BUSINESS_RELATION_SELECT } from "@/modules/users/domain";
    ...
    <Card className="overflow-visible">
      <div role="table" aria-label="Benutzer" className="divide-y divide-slate-200">
        ...
        {users.map((user) => {
          ...
          const lastAdmin = user.active && roles.includes("ADMINISTRATOR") && activeAdministratorCount <= 1;
